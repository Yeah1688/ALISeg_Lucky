...
from nets.deeplabv3_plus_MDCH import DeepLab
...
if __name__ == "__main__":
    ...
    #       在终端中输入    CUDA_VISIBLE_DEVICES=0,1 python train_XAD.py
    #   DDP模式：
    #       设置            distributed = True
    #       在终端中输入    CUDA_VISIBLE_DEVICES=0,1 python -m torch.distributed.launch --nproc_per_node=2 train_XAD.py
    #---------------------------------------------------------------------#
    distributed     = False
    #---------------------------------------------------------------------#
